...
\urlh{eval4tex.tar.bz2}{Version 20090506}}
%\c{Included with \urlh{tex2page-doc.html}{TeX2page}}
\c{\urlh{http://www.ccs.neu.edu/~dorai}{Dorai Sitaram}}
...
auxiliary file called \p{circle.eval4tex}
that extracts the \p{\eval}-embedded Scheme code from \p{circle.tex}.

Now evaluate the Scheme file \p{circle.eval4tex}.  For example, with
Racket, you could do
...
\p{circlepic.eval4tex}, and then \TeX\ again on
\p{circlepic.tex}:
